import { filterDirector, filterProducer, computeVehicle, computeFemaleCharacterPercentage } from '../src/data.js'; //se borra lo que va dentro de las llaves
...
describe('computeFemaleCharacterPercentage', () => {
  it('is a function', () => {
    expect(typeof computeFemaleCharacterPercentage()).toBe('funtion');
  });
});
