import {// Importar funciones desde el archivo data.js y el archivo ghibli.js
...
function show(dataghibli) {// Definición de la función show para mostrar las películas en la página
  const dataMovies = document.getElementById("gridmovies");// Obtener el elemento HTML con id "gridmovies"

  for (let gh = 0; gh < dataghibli.length; gh++) {// Iterar a través de las películas en dataghibli
